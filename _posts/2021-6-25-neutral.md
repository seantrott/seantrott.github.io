...
Either way, my view is that building out a neutral model––building a baseline––should be an important part of making any evolutionary claim, if only as a kind of disciplining exercise. Just-so stories are satisfying to construct (and to read), and I think that makes them all the more tempting. Building a baseline makes our task a little harder, but I think that's a good thing.

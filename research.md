...
- Rivière, P., & **Trott, S.** (To appear). Start Making Sense(s): A Developmental Probe of Attention Specialization Using Lexical Ambiguity. Transactions of the Association for Computational Linguistics (TACL). 
